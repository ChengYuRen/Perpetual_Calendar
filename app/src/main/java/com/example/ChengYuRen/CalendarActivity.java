package com.example.ChengYuRen;
...
import com.example.ChengYuRen.Adapter.CalendarPagerAdapter;
...
public class CalendarActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.tv_calendar) { // 点击了年份文本
            // 重新选择万年历的年月
            resetPage();
        } else if (view.getId() == R.id.btn_ok) { // 点击了确定按钮
